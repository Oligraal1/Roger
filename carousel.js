...
var allCarousels = document.querySelectorAll('.carousel-container');
...
//	console.log(carousel);
	...
	carousel.buttons = {
		"prev": carousel.container.querySelector('.carousel-previous'),
		"next": carousel.container.querySelector('.carousel-advance')
	};
...
function displayCarouselItem(carousel) {
	...
	carousel.figureCont.style.marginLeft = -1 * (carousel.currentItem * 500);
}
